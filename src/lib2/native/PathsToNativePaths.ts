...
export function nativePathsToPaths(nativeClipperLib: NativeClipperLibInstance, nativePaths: NativePaths): Paths {
  const array = nativePathsToDoubleArray(nativeClipperLib, nativePaths, true);
